# Run 01 — Standard PKR 2B Funding Round

**Mode:** Demo Mode (deterministic, rule-based reasoning over real tool results)
**Funding envelope:** PKR 2,000M
**Dataset:** 4083 projects, PKR 51,550.1M total portfolio, 39 districts

## Agent Plan & Tool Calls (Agent Activity Panel)

```text
[Coordinator] PLAN: load dataset, dispatch Finance/Delivery/Equity reviews, then rank & select Not Started candidates within the PKR 2000M funding envelope.
...
[Coordinator] ACT: calling select_within_budget() to enforce the PKR 2000M cap and district/category concentration limits.
[Coordinator] OBSERVE: selected 309 projects totaling 1999.32M (remaining 0.68M).
...
*(+ 299 more projects in the full run — see CSV export in the app)*
